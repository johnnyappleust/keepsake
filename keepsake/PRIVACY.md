...
_Last updated: September 2026 · applies to Keepsake 1.0.0_
...
- **Background worker:** has no timers and no network access. It wakes only for messages from Keepsake's own pages/scripts, the context menu and permission or settings changes.
